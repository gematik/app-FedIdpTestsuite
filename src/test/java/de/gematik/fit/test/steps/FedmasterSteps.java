...
public class FedmasterSteps {
  ...
  static final String IDP_FEDMASTER_LTU_RUN_URL = "fedmaster";
  ...
  public static String replaceHostForTiger(final String url) {
    ...
    return builder.host(IDP_FEDMASTER_LTU_RUN_URL).port(null).scheme("http").toUriString();
  }

  public void fetchEntStmnt() {
    sendGetRequestTo("http://" + IDP_FEDMASTER_LTU_RUN_URL + ENTITY_STATEMENT_ENDPOINT, null);
  }
